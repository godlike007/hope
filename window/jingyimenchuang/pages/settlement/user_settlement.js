...
Page({
  ...
  onShow: function () {
    ...
    thisObj.getDetail(this.data.productId);
  },
  getDetail(productId) {
    if (productId) {
      var data = {
      ...
      var thisObj = this;
      request.get(config.hmcApiHost + "goods/detail/" + productId, data).then(function (res) {
  ...
  unitedPayRequest: function (openid, productName, orderNo, _thisObj) {
    ...
    var total_fee = parseInt(100.0 * 100); //价格，这是一分钱
