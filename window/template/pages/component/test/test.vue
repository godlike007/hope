<template>
	<view>
		...
		<view class="panel">
			<view>
				本双周结算分析
				<view class="num">367户</view>
				,平均毛利率
				<view class="num">32.08%</view>
				,环比上双周平均毛利率下降
				<view class="num">0.73个</view>
				百分点
			</view>
			<view>
				9月截至当前结算分析
	...
	methods: {
		...
		getServerData() {
			...
			uni.request({
				...
				header: {
					'app-device-id': 'HUAWEIEVA-TL00-B2T7N16C10001991', //自定义请求头信息
					'app-device-type': 'android', //自定义请求头信息
					'app-id': 'com.goldmantis.appjia', //自定义请求头信息
					'app-version': '4.32.0', //自定义请求头信息
					'token': '9170b5ab5a4a41e7a11cab4806e2770e', //自定义请求头信息
