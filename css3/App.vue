					...
					<div class="config">
						...
						<div class="config-item"  v-if="checked_item.includes('width')">
							<el-row :gutter="20">
								...
								<template>
								  <div class="block">
								    <el-slider :max='1000'  @change="toggel_attr_add_px('width')"
								      v-model="css_attr.width"
								      show-input>
								    </el-slider>
								  </div>
								</template>
						...
						<div class="config-item"  v-if="checked_item.includes('height')">
							<el-row :gutter="20">
								...
								<template>
								  <div class="block">
								    <el-slider :max='1000'  @change="toggel_attr_add_px('height')"
								      v-model="css_attr.height"
								      show-input>
								    </el-slider>
								  </div>
								</template>
						...
						<div class="config-item" v-if="checked_item.includes('top')">
							<el-row :gutter="20">
								...
								<template>
								  <div class="block">
								    <el-slider   @change="toggel_attr_add_px('top')"
								      v-model="css_attr.top"
								      show-input>
								    </el-slider>
								  </div>
								</template>
						...
						<div class="config-item" v-if="checked_item.includes('left')">
							<el-row :gutter="20">
								...
								<template>
								  <div class="block">
								    <el-slider   @change="toggel_attr_add_px('left')"
								      v-model="css_attr.left"
								      show-input>
								    </el-slider>
								  </div>
								</template>
						...
						<div class="config-item" v-if="checked_item.includes('right')">
							<el-row :gutter="20">
								...
								<template>
								  <div class="block">
								    <el-slider   @change="toggel_attr_add_px('right')"
								      v-model="css_attr.right"
								      show-input>
								    </el-slider>
								  </div>
								</template>
						...
						<div class="config-item" v-if="checked_item.includes('bottom')">
							<el-row :gutter="20">
								...
								<template>
								  <div class="block">
								    <el-slider  @change="toggel_attr_add_px('bottom')"
								      v-model="css_attr.bottom"
								      show-input>
								    </el-slider>
								  </div>
								</template>
						...
						<div class="config-item" v-if="checked_item.includes('backgroundColor')">
							<el-row :gutter="20">
								...
								<el-col :span="24">
								<el-color-picker   @change="toggel_attr('backgroundColor')"
								v-model="css_attr.backgroundColor"></el-color-picker>
						...
						<div class="config-item" v-if="checked_item.includes('backgroundPosition')">
							<el-row :gutter="20">
								...
								<template>
								  <div class="block">
								    <el-slider @change="toggel_background_position('backgroundPosition')"
						...
						<div class="config-item" v-if="checked_item.includes('backgroundSize')">
							<el-row :gutter="20">
								...
								<template v-if="['length', 'percentage'].includes(css_attr_detail.backgroundSize.type)">
								  <div class="block">
								    <el-slider @change="toggel_background_size_w_h"
								      v-model="css_attr_detail.backgroundSize.width"
								      show-input>
								    </el-slider>
								  </div>
								  <div class="block">
								    <el-slider  @change="toggel_background_size_w_h"
								      v-model="css_attr_detail.backgroundSize.height"
								      show-input>
								    </el-slider>
								  </div>
						...
						<div class="config-item" v-if="checked_item.includes('borderTop')">
							<el-row :gutter="20">
								...
								<el-col :span="16">
									...
									<template>
									  <div class="block">
									    <el-slider  @change="toggel_border('borderTop')"
									      v-model="css_attr_detail.borderTop.width"
									      show-input>
									    </el-slider>
									  </div>
								 ...
								 <div class="block">
								<el-color-picker  @change="toggel_border('borderTop')" v-model="css_attr_detail.borderTop.color"></el-color-picker>
									 </div>
								</el-col>
							</el-row>
						</div>
						...
						<div class="config-item" v-if="checked_item.includes('borderLeft')">
							<el-row :gutter="20">
								...
								<el-col :span="16">
									...
									<template>
									  <div class="block">
									    <el-slider  @change="toggel_border('borderLeft')"
									      v-model="css_attr_detail.borderLeft.width"
									      show-input>
									    </el-slider>
									  </div>
								 ...
								 <div class="block">
								<el-color-picker v-model="css_attr_detail.borderLeft.color"></el-color-picker>
									 </div>
								</el-col>
							</el-row>
						</div>
						...
						<div class="config-item" v-if="checked_item.includes('borderRight')">
							<el-row :gutter="20">
								...
								<el-col :span="16">
									...
									<template>
									  <div class="block">
									    <el-slider  @change="toggel_border('borderRight')"
									      v-model="css_attr_detail.borderRight.width"
									      show-input>
									    </el-slider>
									  </div>
								 ...
								 <div class="block">
								<el-color-picker @change="toggel_border('borderRight')" v-model="css_attr_detail.borderRight.color"></el-color-picker>
									 </div>
								</el-col>
							</el-row>
						</div>
						...
						<div class="config-item" v-if="checked_item.includes('borderBottom')">
							<el-row :gutter="20">
								...
								<el-col :span="16">
									...
									<template>
									  <div class="block">
									    <el-slider  @change="toggel_border('borderBottom')"
									      v-model="css_attr_detail.borderBottom.width"
									      show-input>
									    </el-slider>
									  </div>
						...
						<div class="config-item" v-if="checked_item.includes('borderRadius')">
							...
							<el-radio-group  v-model="css_attr_detail.borderRadius.type">
								  ...
								  <el-radio  label="percentage">percentage</el-radio>
									...
									<div class="block">
									  <el-slider  @change="toggel_border_radius"
									    v-model="css_attr_detail.borderRadius.val1"
									    show-input>
									  </el-slider>
									  
									  <el-slider  @change="toggel_border_radius"
									    v-model="css_attr_detail.borderRadius.val2"
									    show-input>
									  </el-slider>
									  <el-slider  @change="toggel_border_radius"
									    v-model="css_attr_detail.borderRadius.val3"
									    show-input>
									  </el-slider>
									  <el-slider  @change="toggel_border_radius"
									    v-model="css_attr_detail.borderRadius.val4"
									    show-input>
									  </el-slider>
									</div>
									</template>
									...
									<div class="block">
									  ...
									  <el-slider  @change="toggel_border_radius"
									    v-model="css_attr_detail.borderRadius.val5"
									    show-input>
									  </el-slider>
									  
									  <el-slider  @change="toggel_border_radius"
									    v-model="css_attr_detail.borderRadius.val6"
									    show-input>
									  </el-slider>
									  <el-slider  @change="toggel_border_radius"
									    v-model="css_attr_detail.borderRadius.val7"
									    show-input>
									  </el-slider>
									  <el-slider  @change="toggel_border_radius"
									    v-model="css_attr_detail.borderRadius.val8"
									    show-input>
									  </el-slider>
									</div>
						...
						<div class="config-item" v-if="checked_item.includes('transform')">
							<el-row :gutter="20">
								...
								<el-col :span="16">
									...
									<div class="block">
										translate3d({{css_attr_detail.transform.translate3d.x}},{{css_attr_detail.transform.translate3d.y}},{{css_attr_detail.transform.translate3d.z}})
									</div>								
								
								<template>
								  <div class="block">
								    <el-slider @change="toggel_transform"
								      v-model="css_attr_detail.transform.translate3d.x"
								      show-input>
								    </el-slider>
								  </div>
								  <div class="block">
								    <el-slider  @change="toggel_transform"
								      v-model="css_attr_detail.transform.translate3d.y"
								      show-input>
								    </el-slider>
								  </div>
								  <div class="block">
								    <el-slider  @change="toggel_transform"
								      v-model="css_attr_detail.transform.translate3d.z"
								      show-input>
								    </el-slider>
								  </div>
								...
								<template>
								  <div class="block">
								    <el-slider @change="toggel_transform"
								      v-model="css_attr_detail.transform.scale3d.x"
								      show-input>
								    </el-slider>
								  </div>
								  <div class="block">
								    <el-slider  @change="toggel_transform"
								      v-model="css_attr_detail.transform.scale3d.y"
								      show-input>
								    </el-slider>
								  </div>
								  <div class="block">
								    <el-slider  @change="toggel_transform"
								      v-model="css_attr_detail.transform.scale3d.z"
								      show-input>
								    </el-slider>
								  </div>
								...
								<el-col :span="16">
									...
									<div class="block">
										rotate3d({{css_attr_detail.transform.rotate3d.x}},{{css_attr_detail.transform.rotate3d.y}},{{css_attr_detail.transform.rotate3d.z}},{{css_attr_detail.transform.rotate3d.deg}}deg)
									</div>	
																
																
										<el-switch @change="toggel_transform"
										  v-model="is_rotate3d"
										  active-text="rotate3d模式"
										  inactive-text="传统模式">
										</el-switch>
								...
								<template v-if="is_rotate3d">
								  <div class="block">
								    <el-slider @change="toggel_transform"
								      v-model="css_attr_detail.transform.rotate3d.x"
								      show-input>
								    </el-slider>
								  </div>
								  <div class="block">
								    <el-slider  @change="toggel_transform"
								      v-model="css_attr_detail.transform.rotate3d.y"
								      show-input>
								    </el-slider>
								  </div>
								  <div class="block">
								    <el-slider  @change="toggel_transform"
								      v-model="css_attr_detail.transform.rotate3d.z"
								      show-input>
								    </el-slider>
								  </div>
								  <div class="block">
								    <el-slider  @change="toggel_transform"
								      v-model="css_attr_detail.transform.rotate3d.deg"
								      show-input>
								    </el-slider>
								  </div>
								...
								<template v-if="!is_rotate3d">
								  <div class="block">
								    <el-slider @change="toggel_transform" :max='360'
								      v-model="css_attr_detail.transform.rotate3d._x"
								      show-input>
								    </el-slider>
								  </div>
								  <div class="block">
								    <el-slider  @change="toggel_transform" :max='360'
								      v-model="css_attr_detail.transform.rotate3d._y"
								      show-input>
								    </el-slider>
								  </div>
								  <div class="block">
								    <el-slider  @change="toggel_transform" :max='360'
								      v-model="css_attr_detail.transform.rotate3d._z"
								      show-input>
								    </el-slider>
								  </div>
								</template>
								...
								<el-col :span="16">
									...
									<div class="block">
										skew({{css_attr_detail.transform.skew.x}},{{css_attr_detail.transform.skew.y}})
									</div>			
								<template>
								  <div class="block">
								    <el-slider @change="toggel_transform" :max='180'
								      v-model="css_attr_detail.transform.skew.x"
								      show-input>
								    </el-slider>
								  </div>
								  <div class="block">
								    <el-slider  @change="toggel_transform"
								      v-model="css_attr_detail.transform.skew.y"
								      show-input>
								    </el-slider>
								  </div>
								...
								<el-col :span="16">
									<div class="block">
										perspective({{css_attr_detail.transform.perspective}})
									</div>	
									<template>
								<el-slider  @change="toggel_transform" :max='1000'
								  v-model="css_attr_detail.transform.perspective"
								  show-input>
								</el-slider>
								</template>
								</el-col>
						...
						<div class="config-item" v-if="checked_item.includes('transformOrigin')">
							<el-row :gutter="20">
								...
								<el-col :span="24">
								  ...
								  <div class="block">
								    <el-slider @change="toggel_transform_origin('transformOrigin')"
								      v-model="css_attr_detail.transformOrigin.x"
								      show-input>
								    </el-slider>
								  </div>
								  <div class="block">
								    <el-slider  @change="toggel_transform_origin('transformOrigin')"
								      v-model="css_attr_detail.transformOrigin.y"
								      show-input>
								    </el-slider>
								  </div>
								  <div class="block">
								    <el-slider  @change="toggel_transform_origin('transformOrigin')"
								      v-model="css_attr_detail.transformOrigin.z"
								      show-input>
								    </el-slider>
								  </div>
...
export default {
	...
	methods: {
		...
		toggel_transform_origin() {
			this.css_attr.transformOrigin = this.css_attr_detail.transformOrigin.x+'% '+this.css_attr_detail.transformOrigin.y+"% "+this.css_attr_detail.transformOrigin.z+"px";
		...
		toggel_transform() {		
			debugger;
			this.css_attr.transform = `translate3d(${this.css_attr_detail.transform.translate3d.x}px,${this.css_attr_detail.transform.translate3d.y}px,${this.css_attr_detail.transform.translate3d.z}px)`;
			 this.css_attr.transform+=` scale3d(${this.css_attr_detail.transform.scale3d.x},${this.css_attr_detail.transform.scale3d.y},${this.css_attr_detail.transform.scale3d.z})`;
			 
			 if(this.is_rotate3d){
				this.css_attr.transform+=` rotate3d(${this.css_attr_detail.transform.rotate3d.x},${this.css_attr_detail.transform.rotate3d.y},${this.css_attr_detail.transform.rotate3d.z},${this.css_attr_detail.transform.rotate3d.deg}deg)`;
				 
			 }
			 else{
				this.css_attr.transform+=` rotateX(${this.css_attr_detail.transform.rotate3d._x}deg) rotateY(${this.css_attr_detail.transform.rotate3d._y}deg) rotateZ(${this.css_attr_detail.transform.rotate3d._z}deg)`;
		...
		toggel_border_radius() {
			if(this.css_attr_detail.borderRadius.type=="length"){
				this.css_attr.borderRadius = this.css_attr_detail.borderRadius.val1+'px '
				+this.css_attr_detail.borderRadius.val2+'px '
				+this.css_attr_detail.borderRadius.val3+'px '
				+this.css_attr_detail.borderRadius.val4+'px'
			}
			else{
			this.css_attr.borderRadius = this.css_attr_detail.borderRadius.val1+'% '
